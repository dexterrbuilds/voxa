...
const navItems = [
  { icon: Home, label: "Dashboard", href: "/synq" },
  { icon: User, label: "Profile", href: "/synq/profile" },
  { icon: Settings, label: "Settings", href: "/synq/settings" },
];
