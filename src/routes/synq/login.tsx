...
import WelcomeHero from "@/components/synq/auth/WelcomeHero";
import AnimatedBackground from "@/components/synq/auth/AnimatedBackground";

export default function SynqLoginPage() {
