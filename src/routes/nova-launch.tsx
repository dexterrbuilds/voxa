  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-16 text-center sm:pt-24">
        <img src="/synq-mark.svg" width={56} height={56} alt="" className="mx-auto mb-8" />
        ...
        <a
          href={href}
          className="mt-8 inline-flex min-h-12 items-center gap-3 rounded-lg bg-electric px-6 py-3 font-semibold text-primary-foreground"
        >
        ...
        <div className="mx-auto mt-14 max-w-2xl border-t border-border pt-8 text-left">
          ...
          <a
            href={href}
            className="mt-6 flex min-h-20 items-center gap-4 rounded-xl border border-border bg-card px-5 shadow-sm"
          >
