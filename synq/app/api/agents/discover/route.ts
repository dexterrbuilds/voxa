...
import { fetchHandshake, SUPPORTED_SDK_VERSIONS } from "@/lib/server/agents/verification";
...
import { isSupportedAgentProtocol } from "@/lib/agents/protocol-compatibility";
...
export async function POST(request: NextRequest) {
  ...
  if (
    !isSupportedAgentProtocol(handshake.protocol) ||
