...
import { postSynqMessage, SYNQ_VOICE_TYPE } from "@/lib/server/agents/runtime/synqMessageClient";
...
// the same wire client (`synqMessageClient`). The differences are the forced
