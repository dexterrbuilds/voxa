...
const DOCS_URL = `${(process.env.NEXT_PUBLIC_MARKETING_URL || "http://localhost:5173").replace(/\/$/, "")}/developers/docs`;
const SDK_DOCS_URL = `${DOCS_URL}/sdk`;
                  ...
                  <div className="border-b border-[var(--glass-border)] pb-5">
                    ...
                    >
                      <input
                        ...
                        maxLength={600}
                        placeholder="https://your-agent.example/synq/handshake"
                  ...
                  {form.importSource !== "custom_endpoint" ? (
                    <div className="flex items-start gap-2 rounded-lg border border-amber-400/25 bg-amber-400/[0.06] p-3 text-xs leading-relaxed text-[var(--warning)]">
                      ...
                      <span>
                        ...
                        <span className="font-mono">/synq/handshake</span>,{" "}
                        <span className="font-mono">/synq/message</span>). See the openclaw-adapter
